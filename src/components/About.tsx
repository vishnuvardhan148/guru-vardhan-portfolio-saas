          ...
          <MotionWrapper delay={0.2} direction="right">
            <div className="rounded-2xl overflow-hidden shadow-xl bg-gradient-to-br from-primary/80 to-violet-600 p-1">
              <div className="bg-white rounded-xl p-6 h-full">
                <div className="aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-primary/10 to-violet-500/10 flex items-center justify-center">
                  <div className="text-8xl font-bold gradient-text p-8">VVG</div>
                </div>
              </div>
            </div>
          </MotionWrapper>
